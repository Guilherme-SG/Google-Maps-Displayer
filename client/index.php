...
<body>
		...
		<div class="row">
 		...
 		<div class="row" >
 			...
 			<div id="btnCreateMap"
 				...
 				<button class="btn btn-success col-md-3 pull-right align-middle" 
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBCxZVYxgrPSJLIzXfY_8Ac5MhcI8VWxrQ"></script>
	...
	<script src="js/app/views/AddressView.js"></script>
